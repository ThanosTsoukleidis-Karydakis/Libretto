...
class editEvent extends StatefulWidget {
  int id;
  editEvent({Key? key, required this.id}) : super(key: key);

  @override
  _AddNewEventState createState() => _AddNewEventState(id);
}

class _AddNewEventState extends State<editEvent> {
  int id;
  String? ID;
  _AddNewEventState(this.id) : ID = id.toString();
  ...
  void initState() {
    super.initState();
    _locationController = TextEditingController(text: pubevents[id].location);
    type1 = pubevents[id].type1;
  }
                  ...
                  children: [
                    ...
                    Visibility(
                        ...
                        child: Text(_alarmDate != null
                            ...
                            : (pubevents[id].dateAlarm?.year == null ||
                                    pubevents[id]
                                            .dateAlarm
                                            ?.month
                                            .toString()
                                    ...
                                    pubevents[id]
                                        ...
                                        null)
                                ? 'No Date'
                                : ('${pubevents[id].dateAlarm?.year}-${pubevents[id].dateAlarm?.month.toString().padLeft(2, '0')}-${pubevents[id].dateAlarm?.day.toString().padLeft(2, '0')}'))),
                    Visibility(
                    ...
                    Visibility(
                        ...
                        child: Text(_alarmTime != null
                            ...
                            : (pubevents[id].alarm?.hour == null ||
                                    pubevents[id].alarm?.minute == null)
                                ? 'No Time'
                                : ('${pubevents[id].alarm?.hour}'
                                        .padLeft(2, '0') +
                                    ':' +
                                    '${pubevents[id].alarm?.minute}'
                                        .padLeft(2, '0')))),
                    Visibility(
              ...
              IconButton(
                ...
                onPressed: () {
                  if (type1 != null) {
                    _visibleVal = false;
                    final event = Event(
                        type1: type1 == null ? pubevents[id].type1 : type1,
                        location: _locationController.text == null
                            ? pubevents[id].location
                            : _locationController.text,
                        alarm: _alarmTime == null
                            ? pubevents[id].alarm
                            : _alarmTime,
                        dateAlarm: _alarmDate == null
                            ? pubevents[id].dateAlarm
                            : _alarmDate,
                        checked: false);
