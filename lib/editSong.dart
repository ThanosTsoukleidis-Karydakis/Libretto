...
class editSong extends StatefulWidget {
  int id;
  editSong({Key? key, required this.id}) : super(key: key);

  @override
  _AddNewSongState createState() => _AddNewSongState(id);
}

class _AddNewSongState extends State<editSong> {
  int id;
  String? ID;
  _AddNewSongState(this.id) : ID = id.toString();
  ...
  void initState() {
    super.initState();
    _titleController = TextEditingController(text: pubsongs[id].title);
    my_pdf = pubsongs[id].pdf_link;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text("Edit '${pubsongs[id].title}'"),
